...
Original file is located at
    https://colab.research.google.com/drive/1EW3qbnf-bsdZQzfkvCvtr09SQlEbyTGU
"""
...
# Convert 'paid' to numeric (if needed)
...
# Plot the relationship between 'paid' and 'G3'
plt.scatter(X_test['paid_yes'], y_test, color='black')  # Assuming 'yes' indicates receiving paid
plt.plot(X_test['paid_yes'], y_pred, color='blue', linewidth=3)
plt.xlabel('paid_yes')
plt.ylabel('G3')
plt.title('Relationship between paid and G3')
plt.show()
...
# new_data = {'paid_yes': 1, 'G1': 15, 'G2': 16}
# new_data_df = pd.DataFrame([new_data])

X.head()

# Use the trained model to predict G3 for the new data point
# predicted_g3 = model.predict(new_data_df[['paid_yes', 'G1', 'G2']])

# # Display the result
# print("Predicted G3 for a student with paid_yes:", predicted_g3[0])
