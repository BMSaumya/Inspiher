...
Original file is located at
    https://colab.research.google.com/drive/1JRxQR7wrKAnFRgVgOp6HdgfmSPBrklXG
"""
...
# Convert 'famsup' to numeric (if needed)
...
plt.xlabel('famsup')
plt.ylabel('G3')
plt.title('Relationship between famsup and G3')
plt.show()
...
# Plot the relationship between 'famsup' and 'G3'
plt.scatter(X_test['famsup_yes'], y_test, color='black')  # Assuming 'yes' indicates receiving Family support
plt.plot(X_test['famsup_yes'], y_pred, color='blue', linewidth=3)
plt.xlabel('famsup_yes')
plt.ylabel('G3')
plt.title('Relationship between famsup and G3')
plt.show()
...
# new_data = {'famsup_yes': 1, 'G1': 15, 'G2': 16}
# new_data_df = pd.DataFrame([new_data])

X.head()

# Use the trained model to predict G3 for the new data point
# predicted_g3 = model.predict(new_data_df[['famsup_yes', 'G1', 'G2']])

# # Display the result
# print("Predicted G3 for a student with famsup_yes:", predicted_g3[0])
